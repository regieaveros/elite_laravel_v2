...
export default {
    ...
    data() {
        return {
            form: new Form({
                firstname: JSON.parse(this.crew).firstname,
                middlename: JSON.parse(this.crew).middlename,
                lastname: JSON.parse(this.crew).lastname,
                email: JSON.parse(this.crew).email,
                birthdate: JSON.parse(this.crew).birthdate,
                age: JSON.parse(this.crew).age,
                address: JSON.parse(this.crew).address,
                rank: JSON.parse(this.crew).rank,
                height: JSON.parse(this.crew).height,
                weight: JSON.parse(this.crew).weight,
            })
        }
    },
    methods: {
        Update() {
            const id = JSON.parse(this.crew).id;
            axios.put('/crew/update/'+id, this.form)
            .then((response) => {
